    ...
    <section class="detail w-[90%] py-14  flex gap-10 items-start mx-auto">
        <div class="big-img w-[40%]  mx-auto overflow-hidden border-[1.5px] border-solid border-gray-500   group transition-all duration-300 ease-in-out">
            ...
            <div class=" font-['Raleway'] w-[60%]  py-3 sm:text-center md:text-left ">
                ...
                <form action="?ma_hh=<?= $hanghoact['ma_hh'] ?>&ctl=add-cart" method="POST">
                <div class="buttons_group">
                    ...
                    <div class="buttons mt-5 mb-5 flex gap-[10px]">
                        ...
                        foreach ($hanghoact['chi_tiet_sp'] as $item) {
                        ?>
                            <label onclick="chitiet(<?= $item['don_gia'] ?>,<?= $item['so_luong'] ?>)" class=" group  cursor-pointer py-2 text-[rgb(36, 36, 36)] relative rounded border border-solid bg-[#F5F5F5]  hover:border-[#62d2a2] ">
                ...
                <div class=" sm:w-[70%] md:w-[90%] md:mx-2 sm:mx-auto sm:gap-4 flex md:gap-2 ">
                    <div class=" sm:gap-6 flex md:gap-2">
                        ...
                        ?>
                            onclick="alert('Vui lòng đăng nhập!')" type="button"
                        <?php
                        }
                        ?>
