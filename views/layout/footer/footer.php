        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 py-8">
            <div>
                ...
                <div class="flex space-x-2">
                    ...
                    <div class="w-10 h-10 bg-[url('<?= url_public ?>/assets/images/color-instagram.webp')] bg-cover text-white rounded-full flex items-center justify-center cursor-pointer">
