...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th8 31, 2023 lúc 05:48 AM
...
(48, 'ngon', 2, 'longlimited', '2023-08-29');
...
(20, 1, '1 Kg', 140000.00, 10000.00, 79),
(21, 2, '1 Kg', 99000.00, 5000.00, 48),
...
(154, 130, '1kg', 29000.00, 8000.00, 10);
...
(53, '212', 3, '2023-08-29', 1, 'longlimited'),
(54, 'ngon', 4, '2023-08-31', 2, 'admin'),
(55, 'ngon', 4, '2023-08-31', 48, 'admin'),
(56, 're', 5, '2023-08-31', 10, 'admin');
...
(2, 'admin', '2023-06-29', 8, 'Đỗ VĂn Long', '0999999999', 'Thanh Dương, Thành Đô, Tứ Xuyên, Trung Quốc', 1232000, 3, '12345678910jqka', 1),
...
(34, 'longlimited', '2023-08-29', 8, 'At vitae qui sed et ', '0999999999', 'hanoi', 159000, 1, '', 1),
(35, 'admin', '2023-08-31', 8, 'admins', '0999999888', 'ha noi', 217000, 1, '123', 1);
...
INSERT INTO `don_vi_van_chuyen` (`ma_van_chuyen`, `ten_van_chuyen`, `gia_van_chuyen`) VALUES
(1, 'Giao hàng nhanh', 29000),
(2, 'Giao hàng tiết kiệm', 36000),
(3, 'Viettel Post', 31000),
(4, 'VNPost', 24000),
(5, 'J&T Express', 25000);
...
CREATE TABLE `hang_hoa` (
  ...
  `hoat_dong_hh` tinyint(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `hang_hoa` (`ma_hh`, `ten_hh`, `ngay_nhap`, `mo_ta`, `dac_biet`, `so_luot_xem`, `ma_loai`, `hoat_dong_hh`) VALUES
(1, 'Thịt ba rọi heo', '2023-06-03', 'Thịt ba chỉ (hay còn gọi là ba rọi) là phần thịt heo được cắt ra từ bụng, không có xương và nhiều mỡ. Sỡ dĩ người ta thường gọi thịt ba chỉ là bởi khi cắt ngang sẽ thấy được phần thịt và mỡ xen kẽ 3 lớp với nhau theo thứ tự lớp thịt, mỡ rồi lại đến lớp thịt', 0, 122, 1, 1),
(2, 'Móng giò', '2023-06-03', 'Phần móng giò trắng nõn được sơ chế và pha lóc khéo léo, mang trọn hương vị của phần da dẻo mềm mềm, lớp gân giòn và thịt ngọt thơm ngon. Móng giò rất giàu Protit, sau khi đưa vào cơ thể sẽ có tác dụng hiệu quả trong việc cải thiện chức năng sinh lý của các cơ quan nội tạng, làm cho các tế bào da giữ được nước nên đỡ bị khô nhăn, khiến cho da bóng và căng', 1, 49, 1, 1),
(3, 'Thịt heo xay', '2023-06-03', 'Loại thịt rất quen thuộc với mỗi bà nội trợ nhờ độ linh hoạt cao trong chế biến, lại nhanh thấm gia vị và có khả năng kết hợp hài hòa với hầu hết các loại rau củ, cho các đầu bếp tại gia thỏa sức biến tấu. Sản phẩm được kết hợp từ thịt nạc và mỡ tươi sạch tạo sự hài hòa cho hương vị và sự an tâm tuyệt đối về chất lượng cho các món ăn', 0, 4, 1, 1),
(4, 'Sườn heo', '2023-06-03', 'Sườn hồng tươi với sụn giòn rụm cùng thịt mềm căng mọng được tuyển chọn kỹ lưỡng từ tảng sườn ngon nhất. Là nguyên liệ hảo hạng cho món ngon đúng điệu. Sườn heo là bộ phận chứa nhiều các chất dinh dưỡng như protein, vitamin B12, kẽm, sắt và chất béo không bão hòa như Omega-3 giúp cung cấp cho cơ thể loạt các vi chất cần thiết', 1, 47, 1, 1),
(5, 'Bắp giò heo', '2023-06-03', 'Chân giò heo tiêu chuẩn về an toàn toàn thực phẩm. Giò heo săn chắc, thịt có sự kết hợp với gân mỡ nên ăn béo ngậy và thơm, thích hợp để hầm canh, nấu các món nước như hủ tiếu, bánh canh. Do chân hoạt động nhiều nên phần thịt sẽ mỏng, mềm, ngọt và có nhiều gân hơn vì vậy mà khi chế biến các món hầm, giả cầy, luộc,... sẽ mềm, thấm gia vị và ngon hơn', 1, 64, 1, 1),
(6, 'Đuôi heo', '2023-06-03', 'Đuôi heo bao gồm cả phần xương đuôi. Phần đuôi gồm chủ yếu là thịt và mỡ, được bao quanh bởi da. Xương và các mẩu sụn nhỏ ở các đầu khớp nối tạo độ giòn khi thưởng thức. Trong thực đơn gia đình thì đây là nguyên liệu lý tưởng cho các món hầm, ninh nhừ để đem lại những món ăn thơm ngon, hương vị đậm đà nhưng không hề béo', 0, 2, 1, 1),
(7, 'Nạc vai heo', '2023-06-03', 'Nạc vai heo là phần thịt đặc trưng được lấy từ đùi trước (vai) của heo. Nạc vai còn bao gồm một phần đầu của thăn ngoại heo (đầu mềm). Chất lượng thịt heo đạt chất lượng cao nhất, thịt heo đều được Cơ quan thú y nhà nước kiểm tra, đóng dấu trước khi đưa ra thị trường tiêu thụ', 1, 5, 1, 1),
(8, 'Bắp bò Úc', '2023-06-03', 'Bắp bò Úc luôn là được xếp trong danh sách dòng sản phẩm best seller ở mọi cửa hàng trong hệ thống. Với thực đơn chế biến đa dạng như bò kho, bò hầm, bò sốt vang, bò luộc, bò xào, bò nướng, bò hấp, sản phẩm đáp ứng nhu cầu ẩm thực phong phú của nhiều gia đình Việt. Hãy đến với Food Market ngay hôm nay để được mua hàng với mức giá tốt nhất', 1, 2, 1, 1),
(9, 'Ba chỉ bò nhập khẩu', '2023-06-03', 'Ba chỉ bò là phần thịt được lấy từ phần bụng của con bò, là phần thịt với những dải thịt nạc và thịt mỡ xen kẽ nhau tạo nên độ mềm, ngậy, ngọt nhưng hoàn toàn không ngấy. Bò nhập khẩu rất dễ chế biến. Những món ăn nấu từ thịt ba chỉ bò cũng rất đơn giản như xào, lẩu, cuốn cải nướng, cuốn nấm kim châm nướng, nhúng giấm hay làm salat', 1, 38, 1, 1),
(10, 'Thăn ngoại bò Úc', '2023-06-03', 'Là sự xen kẽ hoàn hảo giữa lớp thịt và lớp mỡ trên miếng thịt bò tạo nên những hình vân cẩm thạch đẹp mắt.Thịt bò mềm, mọng nước, hợp để làm steak hoặc nhúng lẩu. Thăn ngoại bò vốn nổi tiếng là loại thịt bò cao cấp nhất trên thế giới. Các đường vân mỡ – nạc đan xen đều đặn tựa như đường vân cẩm thạch', 0, 4, 1, 1),
(11, 'Gầu bò Úc', '2023-06-03', 'Gầu bò Úc hay còn gọi là nạm bò, ức bò (Brisket) là sản phẩm nhập khẩu trực tiếp từ các thương hiệu thịt bò hàng đầu của Úc với đầy đủ tem nhãn của nhà sản xuất và dấu kiểm định của Chi Cục Thú Y. Quá trình sơ chế, đóng khay, cấp đông Bò Úc vệ sinh sạch sẽ đảm bảo chất lượng, an toàn cho sức khỏe người tiêu dùng. Gầu Bò Úc được pha cắt bằng máy bào công nghiệp, bào lẩu theo tiêu chuẩn độ dày 1,5mm cho món lẩu.', 1, 15, 1, 1),
(12, 'Gà đồi cao lãnh', '2023-06-03', 'Thịt gà đồi thường có cấu trúc cơ bắp chắc chắn và mềm mại, với một lượng mỡ ít hơn so với các loại gà nuôi công nghiệp. Do được nuôi trong môi trường tự nhiên, gà đồi thường có cơ bắp phát triển tự nhiên hơn và thường được cho ăn các nguồn thức ăn tự nhiên như cỏ, hạt, sâu, giun và côn trùng. Thịt gà đồi là một nguồn cung cấp protein chất lượng cao, vitamin B6, vitamin B12, selen và các khoáng chất khác. Nó là một lựa chọn ăn uống lành mạnh và giàu dinh dưỡng', 0, 2, 1, 1),
(13, 'Cánh gà', '2023-06-03', 'Cánh gà là một phần thịt được lấy từ cánh của con gà. Đây là một phần thịt thường được ưa chuộng và sử dụng phổ biến trong ẩm thực nhiều quốc gia trên thế giới. Cánh gà có cấu trúc xương và thịt cân đối. Phần thịt trên cánh gà thường là mềm mại và có một lượng mỡ nhất định, tạo ra hương vị thơm ngon và độ mềm phù hợ', 1, 5, 1, 1),
(14, 'Đùi gà', '2023-06-03', 'Đùi gà là một phần thịt được lấy từ phần đùi hoặc chân sau của con gà. Đây là một phần thịt gà phổ biến và được sử dụng rộng rãi trong ẩm thực. Khi chế biến, đùi gà có thể được nướng, quay, rán hoặc hấp theo nhiều phong cách khác nhau. Đùi gà thường được tẩm gia vị hoặc sốt để tăng cường hương vị và độ ngon. Đùi gà cũng thích hợp để làm món chính hoặc món ăn nhẹ', 1, 2, 1, 1),
(15, 'Sườn cừu mông cổ', '2023-06-03', 'Sườn cừu Mông Cổ là một sản phẩm thịt từ phần sườn của Cừu Mông Cổ, một loại gia súc được nuôi chủ yếu ở Mông Cổ. Đây là một phần thịt ngon, giàu dinh dưỡng và có một hương vị đặc trưng. Sườn cừu Mông Cổ thường có cấu trúc xương dài và thịt mềm, có nhiều mỡ ở giữa, giúp tạo ra một hương vị giàu mỡ và thơm ngon. Phần thịt được cắt từ sườn cừu thường có lớp mỡ mỏng bao quanh, làm tăng hương vị và giữ cho thịt mềm và không khô', 1, 41, 1, 1),
(16, 'Cá Mập Cambodia', '2023-06-03', 'Cá Mập Cambodia là một sản phẩm độc đáo được chế biến từ cá mập tươi ngon, nổi tiếng từ vùng biển Cambodia. Sản phẩm này mang đến cho bạn trải nghiệm ẩm thực độc đáo với hương vị đậm đà và thịt cá mập mềm mịn. Với sự kết hợp hoàn hảo giữa phương pháp chế biến truyền thống và công nghệ hiện đại, \"Cá Mập Cambodia\" là một món ăn tuyệt vời để khám phá hương vị biển cả và nền ẩm thực', 1, 151, 2, 1),
(17, 'Cá Chim Trắng Lai Châu', '2023-06-11', 'Cá chim có hai loại phổ biển là cá chim trắng và cá chim đen, tuy nhiên cá chim trắng được ưa chuộng nhất bởi cá chim trắng thịt ngon và thơm hơn rất nhiều so với cá chim đen.', 0, 0, 2, 1),
(18, 'Cá Saba Lào Cai', '2023-06-11', 'Cá sa ba tẩm tiêu xanh được nhiều người Việt ưa chuộng bởi độ dinh dưỡng cao và tốt cho sức khỏe. Cá sa ba tẩm tiêu xanh nhập khẩu nguyên liệu trực tiếp từ Nhật về Việt Nam và sau đó bắt đầu sơ chế đóng gói, dán tem, hàng chất lượng tươi ngon.', 0, 0, 2, 1),
(19, 'Cá Hồi Nguyên Con Cao Lãnh', '2023-06-11', 'Cá hồi Nauy là loại thực phẩm giàu dinh dưỡng cho sức khỏe của chúng ta. Chúng được chế biến thành nhiều món ăn ngon, đặc biệt là các món ăn tươi sống như sushi hay sashimi rất được ưa chuộng ở khắp nơi.', 1, 0, 2, 1),
(20, 'Cá Trích Phi Lê', '2023-06-11', 'Cá Trích đặc sản nổi tiếng ở vùng biển Bình Thuận, cá có đặc điểm màu xanh nhẹ, thân dẹp và xương nhỏ. Cá trích Phile được sơ chế từ những con cá trích tươi sống, loại bỏ xương chỉ lấy phần thịt ở 2 bên thân cá.', 0, 0, 2, 1),
(21, 'Cá Tuyết Alaska', '2023-06-11', 'Là khúc gần cuối đuôi được xẻ làm đôi ( như hình). Khúc này có thịt nhiều thích hợp làm nhiều món như: nấu canh chua, nấu cháo, phi lê thịt cá ra chiên hoặc áp chảo. Ngoài ra, khách có thể để nguyên khúc đuôi kho tiêu rất hấp dẫn.', 1, 0, 2, 1),
(22, 'Cá Dìa Bông Làm Sạch', '2023-06-11', 'Cá Dìa Bông là hải sản nổi tiếng ở Nha Trang, Cam Ranh được nhiều khách yêu thích. Cá chỉ có theo mùa nên được bán chạy khi có hàng tại Đảo, khách Sài Gòn rất thích ăn cá biển bơi thịt tươi ngon, ngọt và siêu béo.', 1, 6, 2, 1),
(23, 'Cá Dứa 1 Nắng', '2023-06-11', 'Cá dứa 1 nắng là một món ăn rất quen thuộc với người Việt Nam. Vì từ lâu, loại khô cá này đã có mặt trong mọi bữa ăn của người dân ở khắp các vùng miền. Khô cá dứa được chế biến bằng cách sấy khô cá dứa và trộn các gia vị như đường, muối, tỏi, hành, ớt và dầu ăn để tạo nên hương vị đặc trưng.', 1, 0, 2, 1),
(24, 'Cá Chỉ Vàng 2 Nắng', '2023-06-11', 'Cá chỉ vàng ( hay còn gọi là cá ngân chỉ ) cá sống tập trung nhiều ở vùng biển ven Phan Thiết - Bình Thuận vì vậy nên khu vực biển này khá nổi tiếng với khô cá chỉ vàng 2 nắng, và là vùng có khô ngon nhất hiện nay.', 1, 0, 2, 1),
(25, 'Cá Chép Sông Đà', '2023-06-11', 'Cá chép có thể chế biến thành nhiều món ăn hấp dẫn cả thị giác lẫn khứu giác và vị giác. Các món ăn chế biến ngon nhất với nguyên liệu cá chép giòn đó là cá chép giòn nướng muối ớt và cá chép giòn om dưa chua, nướng muối ớt, bạn chỉ cần làm thịt cá chép giòn như hướng dẫn ở trên, sau đó giã một chén muối ớt tùy theo khẩu vị của bạn rồi ướp cá với chút dầu ăn nữa và nướng. Mách nhỏ các bạn ở món này là với phần muối nếu cho thêm ít đường vào sẽ dịu vị cá nướng và ngon hơn.', 1, 8, 2, 1),
(26, 'Cua King Crab', '2023-06-11', 'Cua Hoàng Đế Alaska Cái hay còn gọi là King Crab được nhiều khách hàng ưa chuộng không chỉ tại Việt Nam mà còn rất nhiều nơi trên thế giới vì chất lượng thịt cua được đánh giá là chất lượng ngon ngọt dai mà không có loại hải sản nào có thể vượt mặt được. Vậy cua King Crab cái tại Đảo Hải sản có những đặc điểm gì? Nếu mua nhầm cua kém chất lượng thì Đảo Hải Sản có chính sách gì để bảo vệ khách hàng cùng xem qua nội dung sản phẩm này nhé!', 1, 0, 3, 1),
(27, 'Tôm Hùm Alaska', '2023-06-11', 'So với các loại tôm hùm nội ngoại địa khác thì tôm hùm Alaska baby size nhỏ đang được Đảo Hải Sản nhập khẩu về, đây là dòng sản phẩm được ưa chuộng nhất hiện nay tại Tp Hồ Chí Minh và các tỉnh lân cận. Nếu chúng ta so sánh giá trong tầm 2.000.000đ ngoài những sản phẩm tôm hùm Việt Nam ra thì khách hàng còn có sự lựa chọn tôm hùm alaska', 1, 1, 3, 1),
(28, 'Bào Ngư Hàn Quốc', '2023-06-11', 'Bào ngư là một lọai hải sản nổi tiếng vì độ thơm ngon bổ dưỡng, và nguồn dinh dưỡng quý giá mà chúng mang lại. Vậy đặc điểm của bào ngư, công dụng và cũng như giá thành hiện nay của bào ngư như thế nào, hãy cùng Đảo tìm hiểm qua bài viết sau.', 1, 0, 3, 1),
(29, 'Hàu Nhật Bản', '2023-06-11', 'Hàu sữa Nhật Bản, hay còn gọi là hàu nước ngọt, là một loại hàu được nuôi trong môi trường nước ngọt. Nó được coi là một trong những loại hàu ngon nhất thế giới với vị ngọt tự nhiên, mềm mại và tươi mát. Hàu Nhật là một thực phẩm tuyệt vời cho sức khỏe của chúng ta', 1, 3, 3, 1),
(30, 'Sò Đỏ Canada', '2023-06-11', 'Sò đỏ sống trong môi trường sống tự nhiên có tuổi thọ đến vài thập kỷ. Nó được chôn vùi trong cát và lấy lên bằng máy đào thủy lực ngoài đại dương.Sau khi tách vỏ, sò được trải qua quá trình sơ chế và cấp đông nhanh để giữ được chất lượng tuyệt đối cùng hương vị vốn có', 0, 30, 3, 1),
(31, 'Tôm Hùm Úc', '2023-06-11', 'Tôm hùm Tây Úc thu hút ánh nhìn đầu tiên bởi màu sắc thật đẹp, dinh dưỡng cao và đặc biệt thịt tôm rất là thơm, săn chắc và ngọt lắm. Tôm hùm Tây Úc nổi tiếng trên thế giới. Tôm hùm Tây Úc có hình dáng tựa như tôm hùm xanh Nha Trang, chỉ khác về màu sắc đỏ sậm rất bắt mắt. Ngoài ra tôm hùm Tây Úc nhiều khách dễ nhầm lẫn là tôm hùm Nam Úc vì cả 2 chỉ khác nhau hóa văn trên thân tôm.', 1, 0, 3, 1),
(32, 'Cua Tuyết', '2023-06-11', 'Cua tuyết được nhập sống trực tiếp từ vùng biển nước sâu và cực lạnh khu Bắc Cực, chính vì điều kiện s.ống khắc nghiệt đã tạo nên hương vị đặc trưng của cua tuyết. Được du nhập về Việt Nam thời gian gần đây nhưng đã gây ra \'\'cơn sốt\'\' trong giới sành ăn bởi chất lượng cực đỉnh. Thịt cua chắc từng khối và rất ngọt thịt', 0, 5, 3, 1),
...
(64, 'Bia Hà Nội', '2023-06-12', 'Với một hợp chất chất lượng cao, bia Hà Nội mang đến trải nghiệm uống mượt mà, mềm mại và dễ uống. Nó có một hương vị hài hòa, với một sự pha trộn hoàn hảo giữa vị đắng nhẹ và vị ngọt tự nhiên, tạo cảm giác sảng khoái và thỏa mãn. Bia Hà Nội thường được uống lạnh và là một lựa chọn phổ biến trong các cuộc gặp gỡ bạn bè, tiệc tùng hoặc thưởng thức trong những ngày nóng. Nó cũng thường được kết hợp với các món ăn truyền thống và món ăn vặt như bánh mỳ, hải sản, thịt nướng và nhiều món khác.', 1, 14, 8, 1),
(65, 'Cà phê G7 - 3 In 1', '2023-06-12', 'Cà phê G7 3 in 1 được chiết xuất từ những phần tinh túy nhất có trong từng hạt cà phê, trên công nghệ hàng đầu và bí quyết không thể sao chép để cho ra đời sản phẩm cà phê hòa tan thượng hạng, với hương vị khác biệt, đậm đà, hương thơm độc đáo quyến rũ mà không một sản phẩm cà phê hòa tan nào khác đạt được. Trong suốt 12 năm liên tục cà phê G7 được người tiêu dùng bình chọn là hàng Việt Nam chất lượng cao.', 0, 5, 8, 1),
(66, 'Fanta Cam', '2023-06-12', 'Từ thương hiệu nước ngọt có gas nổi tiếng toàn cầu với mùi vị thơm ngon với hỗn hợp hương tự nhiên cùng chất tạo ngọt tổng hợp, giúp xua tan cơn khát và cảm giác mệt mỏi.  Nước ngọt bổ sung năng lượng làm việc mỗi ngày. Cam kết sản phẩm chính hãng, chất lượng và an toàn', 0, 0, 8, 1),
(67, 'Coca-Cola', '2023-06-12', 'Từ thương hiệu nước ngọt có gas nổi tiếng toàn cầu với mùi vị thơm ngon với hỗn hợp hương tự nhiên cùng chất tạo ngọt tổng hợp, giúp xua tan cơn khát và cảm giác mệt mỏi.  Nước ngọt bổ sung năng lượng làm việc mỗi ngày. Cam kết sản phẩm chính hãng, chất lượng và an toàn', 1, 4, 8, 1),
(68, 'Nước Cam Ép Teppi', '2023-06-12', 'Chiết xuất từ những quả cam mọng nước cùng với những tép cam tươi hấp dẫn tự nhiên. Và được sản xuất theo công nghệ hiện đại, không chất độc hại không ảnh hưởng đến sức khỏe người tiêu dùng. Nước ép cam Teppy nguyên tép chứa nhiều vitamin C hỗ trợ cung cấp năng lượng cho cơ thể.', 0, 1, 8, 1),
...
(70, 'Nước Tăng Lực Sting', '2023-06-12', 'Sản phẩm nước tăng lực với mùi vị thơm ngon, sảng khoái, bổ sung hồng sâm chất lượng. Sting giúp cơ thể bù đắp nước, bổ sung năng lượng, vitamin C và E, giúp xua tan cơn khát và cảm giác mệt mỏi cùng dâu cho nhẹ nhàng và dễ chịu. Cam kết chính hãng, chất lượng và an toàn.', 1, 5, 8, 1),
(71, 'Nước gạo OKF No Sugar', '2023-06-12', 'Nước gạo OKF No Sugar là một lựa chọn tốt cho những người muốn hạn chế tiêu thụ đường hoặc theo chế độ ăn ít đường. Nó là một nguồn cung cấp năng lượng và chứa nhiều chất xơ và vitamin B. Nước gạo OKF No Sugar không chỉ giúp giải khát mà còn mang lại lợi ích cho sức khỏe. Nước gạo OKF No Sugar thích hợp cho mọi lứa tuổi và có thể uống ngay từ chai mà không cần thêm đường. Nó là một sự lựa chọn tuyệt vời cho một loại nước giải khát tự nhiên, không có chất bảo quản hay hương liệu nhân tạo.', 0, 102, 8, 1),
(72, 'Nước trái cây Nutriboots Cam', '2023-06-12', 'Sự kết hợp hoàn hảo từ sữa và nước trái cây vị cam. Sữa trái cây Nutri Boost hương cam chai 297ml giúp bù đắp nước, bổ sung năng lượng, vitamin B3, B6, E, C rất có lợi cho cơ thể,xua tan cơn khát và cảm giác mệt mỏi. Sản phẩm sữa trái cây chất lượng từ thương hiệu Nutriboost', 0, 5, 8, 1),
(122, 'gaga', '2023-07-27', 'Veniam quaerat sit', 0, 0, 1, 1),
(130, 'ca heo', '2023-08-29', 'Consequatur Amet qscasscacsac', 1, 100, 8, 0);
...
('longlimited', '111111', 'At vitae qui sed et ', 'user2.jpeg', '0999999999', 'vucy@mailinator.com', 0, 1),
...
--
ALTER TABLE `binh_luan`
  MODIFY `ma_bl` int(10) NOT NULL AUTO_INCREMENT COMMENT 'mã bình luận', AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT cho bảng `chi_tiet_don_hang`
--
ALTER TABLE `chi_tiet_don_hang`
  MODIFY `ma_ctdh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT cho bảng `chi_tiet_hang_hoa`
--
ALTER TABLE `chi_tiet_hang_hoa`
  MODIFY `ma_cthh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;

--
-- AUTO_INCREMENT cho bảng `danh_gia`
--
ALTER TABLE `danh_gia`
  MODIFY `ma_danh_gia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT cho bảng `don_hang`
--
ALTER TABLE `don_hang`
  MODIFY `ma_dh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `gio_hang`
  MODIFY `ma_gh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;

--
-- AUTO_INCREMENT cho bảng `hang_hoa`
--
ALTER TABLE `hang_hoa`
  MODIFY `ma_hh` int(11) NOT NULL AUTO_INCREMENT COMMENT 'mã hàng hoá', AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT cho bảng `hinh_hang_hoa`
--
ALTER TABLE `hinh_hang_hoa`
  MODIFY `ma_hinh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=340;
